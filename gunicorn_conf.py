...
pidfile = '/www/wwwroot/recall_api/gunicorn.pid'

# 设置访问日志和错误信息日志路径
accesslog = '/www/wwwlogs/python/recall_api/gunicorn_acess.log'
errorlog = '/www/wwwlogs/python/recall_api/gunicorn_error.log'
